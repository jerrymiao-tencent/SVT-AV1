...
SIMD_INLINE void jnt_y_comp_avg_2tap_32x2_avx512(
    const uint8_t *const src, const int32_t src_stride,
    const __m512i *const coeffs, const __m512i factor, const __m512i offset,
    __m256i *const s, const ConvBufType *const dst, const int32_t dst_stride,
...
static INLINE void jnt_y_avg_2tap_32x2_avx512(
    const uint8_t *const src, const int32_t src_stride,
...
static INLINE void jnt_y_avg_2tap_64_avx512(const uint8_t *const src,
    const __m512i *const coeffs,
...
static INLINE void jnt_y_no_avg_2tap_32x2_avx512(
    const uint8_t *const src, const int32_t src_stride,
    const __m512i *const coeffs, const __m512i offset, __m256i *const s,
...
static INLINE void jnt_y_no_avg_2tap_64_avx512(
    const uint8_t *const src, const __m512i *const coeffs, const __m512i offset,
    const __m512i s0, __m512i *const s1, ConvBufType *const dst) {
    __m512i r[2];
...
static void jnt_convolve_y_2tap_avx512(
                ...
                if (w == 32) {
                    ...
                    do {
                        ...
                        jnt_y_comp_avg_2tap_64_avx512(src_ptr + 2 * src_stride,
                            ...
                            dst + dst_stride,
                            dst8 + dst8_stride);
                        jnt_y_comp_avg_2tap_64_avx512(
                            src_ptr + 2 * src_stride + 64,
                            coeffs_512,
                            factor_512,
                            offset_comp_avg_512,
                            s_512[1][1],
...
static void jnt_convolve_y_6tap_avx512(
    const uint8_t *const src, const int32_t src_stride, uint8_t *dst8,
    const int32_t dst8_stride, const int32_t w, const int32_t h,
    const InterpFilterParams *const filter_params_y, const int32_t subpel_y_q4,
    const ConvolveParams *const conv_params) {
            ...
            if (w <= 4) {
                ...
                if (w == 32) {
                    ...
                    s_256[0] = _mm256_loadu_si256(
                        (__m256i *)(src_ptr + 0 * src_stride));
                    s_256[1] = _mm256_loadu_si256(
                        (__m256i *)(src_ptr + 1 * src_stride));
                    s_256[2] = _mm256_loadu_si256(
                        (__m256i *)(src_ptr + 2 * src_stride));
                    s_256[3] = _mm256_loadu_si256(
                        (__m256i *)(src_ptr + 3 * src_stride));
                    s_256[4] = _mm256_loadu_si256(
                        (__m256i *)(src_ptr + 4 * src_stride));
            ...
            if (w <= 4) {
                ...
                if (w == 32) {
                    ...
                    do {
                        ...
                        y_convolve_6tap_32x2_avx512(
                            src_ptr, src_stride, coeffs_512, s_256, ss_512, r);
                        jnt_avg_round_store_32x2_avx512(r,
                            offset_avg_512,
                            dst,
                            dst_stride,
                            dst8,
                    ...
                    do {
                        ...
                        do {
                            ...
                            jnt_avg_round_store_64_avx512(
                                r, offset_avg_512, d, d8);
                            jnt_avg_round_store_64_avx512(r + 2,
                                offset_avg_512,
                                d + dst_stride,
                                d8 + dst8_stride);
        ...
        if (w <= 4) {
            ...
            if (w == 32) {
                ...
                do {
                    ...
                    y_convolve_6tap_32x2_avx512(
                        src_ptr, src_stride, coeffs_512, s_256, ss_512, r);
                    jnt_no_avg_round_store_32x2_avx512(
...
static void jnt_convolve_y_8tap_avx512(
    const uint8_t *const src, const int32_t src_stride, uint8_t *dst8,
    const int32_t dst8_stride, const int32_t w, const int32_t h,
    const InterpFilterParams *const filter_params_y, const int32_t subpel_y_q4,
    const ConvolveParams *const conv_params) {
        ...
        if (conv_params->use_jnt_comp_avg) {
                ...
                if (w <= 16) {
                    ...
                    if (w == 8) {
                        ...
                        s_64[0] = _mm_loadl_epi64(
                            (__m128i *)(src_ptr + 0 * src_stride));
                        s_64[1] = _mm_loadl_epi64(
                            (__m128i *)(src_ptr + 1 * src_stride));
                        s_64[2] = _mm_loadl_epi64(
                            (__m128i *)(src_ptr + 2 * src_stride));
                        s_64[3] = _mm_loadl_epi64(
                            (__m128i *)(src_ptr + 3 * src_stride));
                        s_64[4] = _mm_loadl_epi64(
                            (__m128i *)(src_ptr + 4 * src_stride));
                        s_64[5] = _mm_loadl_epi64(
                            (__m128i *)(src_ptr + 5 * src_stride));
                        s_64[6] = _mm_loadl_epi64(
                            (__m128i *)(src_ptr + 6 * src_stride));

                        // Load lines a and b. Line a to lower 128, line b to
                        // upper 128
                        const __m256i src01 =
                            _mm256_setr_m128i(s_64[0], s_64[1]);
                        const __m256i src12 =
                            _mm256_setr_m128i(s_64[1], s_64[2]);
                        const __m256i src23 =
                            _mm256_setr_m128i(s_64[2], s_64[3]);
                        const __m256i src34 =
                            _mm256_setr_m128i(s_64[3], s_64[4]);
                        const __m256i src45 =
                            _mm256_setr_m128i(s_64[4], s_64[5]);
                        const __m256i src56 =
                            _mm256_setr_m128i(s_64[5], s_64[6]);
                        ...
                        s_128[0] = _mm_loadu_si128(
                            (__m128i *)(src_ptr + 0 * src_stride));
                        s_128[1] = _mm_loadu_si128(
                            (__m128i *)(src_ptr + 1 * src_stride));
                        s_128[2] = _mm_loadu_si128(
                            (__m128i *)(src_ptr + 2 * src_stride));
                        s_128[3] = _mm_loadu_si128(
                            (__m128i *)(src_ptr + 3 * src_stride));
                        s_128[4] = _mm_loadu_si128(
                            (__m128i *)(src_ptr + 4 * src_stride));
                        s_128[5] = _mm_loadu_si128(
                            (__m128i *)(src_ptr + 5 * src_stride));
                        s_128[6] = _mm_loadu_si128(
                            (__m128i *)(src_ptr + 6 * src_stride));

                        // Load lines a and b. Line a to lower 128, line b to
                        // upper 128
                        const __m256i src01 =
                            _mm256_setr_m128i(s_128[0], s_128[1]);
                        const __m256i src12 =
                            _mm256_setr_m128i(s_128[1], s_128[2]);
                        const __m256i src23 =
                            _mm256_setr_m128i(s_128[2], s_128[3]);
                        const __m256i src34 =
                            _mm256_setr_m128i(s_128[3], s_128[4]);
                        const __m256i src45 =
                            _mm256_setr_m128i(s_128[4], s_128[5]);
                        const __m256i src56 =
                            _mm256_setr_m128i(s_128[5], s_128[6]);
                    ...
                    if (w == 32) {
                        ...
                        s_256[4] = _mm256_loadu_si256(
                            (__m256i *)(src_ptr + 4 * src_stride));
                        s_256[5] = _mm256_loadu_si256(
                            (__m256i *)(src_ptr + 5 * src_stride));
                        s_256[6] = _mm256_loadu_si256(
                            (__m256i *)(src_ptr + 6 * src_stride));
                        ...
                        do {
                            src_ptr += 2 * src_stride;
                            y_convolve_8tap_32x2_avx512(src_ptr,
                                src_stride,
                                coeffs_512,
                                s_256,
                                ss_512,
                        ...
                        do {
                            ...
                            s_512[0] = _mm512_loadu_si512(
                                (__m512i *)(s + 0 * src_stride));
                            s_512[1] = _mm512_loadu_si512(
                                (__m512i *)(s + 1 * src_stride));
                            s_512[2] = _mm512_loadu_si512(
                                (__m512i *)(s + 2 * src_stride));
                            s_512[3] = _mm512_loadu_si512(
                                (__m512i *)(s + 3 * src_stride));
                            s_512[4] = _mm512_loadu_si512(
                                (__m512i *)(s + 4 * src_stride));
                            s_512[5] = _mm512_loadu_si512(
                                (__m512i *)(s + 5 * src_stride));
                            s_512[6] = _mm512_loadu_si512(
                                (__m512i *)(s + 6 * src_stride));

                            ss_512[0] =
                                _mm512_unpacklo_epi8(s_512[0], s_512[1]);
                            ss_512[1] =
                                _mm512_unpacklo_epi8(s_512[2], s_512[3]);
                            ss_512[2] =
                                _mm512_unpacklo_epi8(s_512[4], s_512[5]);
                            ss_512[4] =
                                _mm512_unpackhi_epi8(s_512[0], s_512[1]);
                            ss_512[5] =
                                _mm512_unpackhi_epi8(s_512[2], s_512[3]);
                            ss_512[6] =
                                _mm512_unpackhi_epi8(s_512[4], s_512[5]);

                            tt_512[0] =
                                _mm512_unpacklo_epi8(s_512[1], s_512[2]);
                            tt_512[1] =
                                _mm512_unpacklo_epi8(s_512[3], s_512[4]);
                            tt_512[2] =
                                _mm512_unpacklo_epi8(s_512[5], s_512[6]);
                            tt_512[4] =
                                _mm512_unpackhi_epi8(s_512[1], s_512[2]);
                            tt_512[5] =
                                _mm512_unpackhi_epi8(s_512[3], s_512[4]);
                            tt_512[6] =
                                _mm512_unpackhi_epi8(s_512[5], s_512[6]);
            ...
            if (w <= 4) {
                ...
                if (w <= 16) {
                    ...
                    const __m512i offset_avg_512 =
                        _mm512_set1_epi16(offset_avg);
        ...
        if (w <= 4) {
            ...
            if (w <= 16) {
                const __m256i offset_no_avg_256 =
                    _mm256_set1_epi16(offset_no_avg);
                ...
                const __m512i offset_no_avg_512 =
                    _mm512_set1_epi16(offset_no_avg);
...
void eb_av1_jnt_convolve_y_avx512(
...
static INLINE void jnt_copy_avg_round_store_32_avx512(
    const __m512i res, const __m512i offset, const ConvBufType *const dst,
    uint8_t *const dst8) {
    __m512i d;
...
static INLINE void jnt_copy_avg_32_avx512(const uint8_t *const src,
    const __m512i offset_avg_512,
    const ConvBufType *const dst,
    uint8_t *const dst8) {
...
void eb_av1_jnt_convolve_2d_copy_avx512(
    const uint8_t *src, int32_t src_stride, uint8_t *dst8, int32_t dst8_stride,
    int32_t w, int32_t h, InterpFilterParams *filter_params_x,
    InterpFilterParams *filter_params_y, const int32_t subpel_x_q4,
    const int32_t subpel_y_q4, ConvolveParams *conv_params) {
    ...
    if (conv_params->do_average) {
        if (conv_params->use_jnt_comp_avg) {
            ...
            if (w <= 4) {
                ...
                if (w == 32) {
                    ...
                    do {
                        jnt_copy_avg_32_avx512(src + 0 * 32,
                            offset_avg_512,
                            dst + 0 * 32,
                            dst8 + 0 * 32);
                        jnt_copy_avg_32_avx512(src + 1 * 32,
                            offset_avg_512,
                            dst + 1 * 32,
                            dst8 + 1 * 32);
                        src += src_stride;
                    ...
                    do {
                        ...
                        jnt_copy_avg_32_avx512(src + 1 * 32,
                            ...
                            dst + 1 * 32,
                            dst8 + 1 * 32);
                        jnt_copy_avg_32_avx512(src + 2 * 32,
                            offset_avg_512,
                            dst + 2 * 32,
                            dst8 + 2 * 32);
                        jnt_copy_avg_32_avx512(src + 3 * 32,
                            offset_avg_512,
                            dst + 3 * 32,
                            dst8 + 3 * 32);
                        src += src_stride;
        ...
        if (w <= 4) {
            ...
            if (w == 32) {
                ...
                do {
                    jnt_copy_no_avg_32_avx512(
                        src + 0 * 32, offset_no_avg_512, dst + 0 * 32);
                    jnt_copy_no_avg_32_avx512(
                        src + 1 * 32, offset_no_avg_512, dst + 1 * 32);
                    src += src_stride;
                    dst += dst_stride;
                } while (--h);
            }
                ...
                do {
                    ...
                    jnt_copy_no_avg_32_avx512(
                        src + 1 * 32, offset_no_avg_512, dst + 1 * 32);
                    jnt_copy_no_avg_32_avx512(
                        src + 2 * 32, offset_no_avg_512, dst + 2 * 32);
                    jnt_copy_no_avg_32_avx512(
                        src + 3 * 32, offset_no_avg_512, dst + 3 * 32);
                    src += src_stride;
                    dst += dst_stride;
                } while (--h);
            }
...
SIMD_INLINE void jnt_x_comp_avg_2tap_32x2_avx512(
    const uint8_t *const src, const int32_t src_stride,
    const __m512i *const coeffs, const __m512i factor, const __m512i offset,
    const ConvBufType *const dst, const int32_t dst_stride, uint8_t *const dst8,
    const int32_t dst8_stride) {
...
SIMD_INLINE void jnt_x_comp_avg_2tap_64_avx512(
    const uint8_t *const src, const __m512i *const coeffs, const __m512i factor,
...
static INLINE void jnt_x_avg_2tap_32x2_avx512(
    const uint8_t *const src, const int32_t src_stride,
...
static INLINE void jnt_x_avg_2tap_64_avx512(const uint8_t *const src,
    const __m512i *const coeffs,
    const __m512i offset,
    const ConvBufType *const dst,
    uint8_t *const dst8) {
...
static INLINE void jnt_x_no_avg_2tap_32x2_avx512(const uint8_t *const src,
...
SIMD_INLINE void jnt_x_comp_avg_6tap_32x2_avx512(
    const uint8_t *const src, const int32_t src_stride, const __m512i coeffs[3],
    const __m512i filt[3], const __m512i factor, const __m512i offset,
    ConvBufType *const dst, const int32_t dst_stride, uint8_t *const dst8,
    const int32_t dst8_stride) {
    __m512i r[2];
...
SIMD_INLINE void jnt_x_comp_avg_6tap_64_avx512(
    const uint8_t *const src, const __m512i coeffs[3], const __m512i filt[3],
...
SIMD_INLINE void jnt_x_avg_6tap_32x2_avx512(
    const uint8_t *const src, const int32_t src_stride, const __m512i coeffs[3],
...
SIMD_INLINE void jnt_x_avg_6tap_64_avx512(
    const uint8_t *const src, const __m512i coeffs[3], const __m512i filt[3],
    const __m512i offset, ConvBufType *const dst, uint8_t *const dst8) {
    __m512i r[2];
...
static INLINE void jnt_x_no_avg_6tap_32x2_avx512(
    const uint8_t *const src, const int32_t src_stride, const __m512i coeffs[3],
    const __m512i filt[3], const __m512i offset, ConvBufType *const dst,
    const int32_t dst_stride) {
    __m512i r[2];
...
SIMD_INLINE void jnt_x_no_avg_6tap_64_avx512(const uint8_t *const src,
...
SIMD_INLINE void jnt_x_comp_avg_8tap_32x2_avx512(
    const uint8_t *const src, const int32_t src_stride, const __m512i coeffs[4],
    const __m512i filt[4], const __m512i factor, const __m512i offset,
    ConvBufType *const dst, const int32_t dst_stride, uint8_t *const dst8,
    const int32_t dst8_stride) {
    __m512i r[2];
...
SIMD_INLINE void jnt_x_comp_avg_8tap_64_avx512(
    const uint8_t *const src, const __m512i coeffs[4], const __m512i filt[4],
    const __m512i factor, const __m512i offset, ConvBufType *const dst,
    uint8_t *const dst8) {
    __m512i r[2];
...
SIMD_INLINE void jnt_x_avg_8tap_32x2_avx512(
    const uint8_t *const src, const int32_t src_stride, const __m512i coeffs[4],
...
SIMD_INLINE void jnt_x_avg_8tap_64_avx512(
    const uint8_t *const src, const __m512i coeffs[4], const __m512i filt[4],
    const __m512i offset, ConvBufType *const dst, uint8_t *const dst8) {
    __m512i r[2];
...
SIMD_INLINE void jnt_x_no_avg_8tap_32x2_avx512(
    const uint8_t *const src, const int32_t src_stride, const __m512i coeffs[4],
    const __m512i filt[4], const __m512i offset, ConvBufType *const dst,
    const int32_t dst_stride) {
    __m512i r[2];
...
SIMD_INLINE void jnt_x_no_avg_8tap_64_avx512(const uint8_t *const src,
...
static void jnt_convolve_x_2tap_avx512(
    const uint8_t *const src, const int32_t src_stride, uint8_t *dst8,
    const int32_t dst8_stride, const int32_t w, const int32_t h,
    ...
    if (conv_params->do_average) {
        if (conv_params->use_jnt_comp_avg) {
            ...
            if (w <= 4) {
                ...
                if (w == 32) {
                    ...
                    do {
                        jnt_x_comp_avg_2tap_64_avx512(src_ptr,
                            coeffs_512,
                            factor_512,
                            offset_comp_avg_512,
                            dst,
                ...
                if (w == 32) {
                    ...
                    do {
                        jnt_x_avg_2tap_64_avx512(
                            src_ptr, coeffs_512, offset_avg_512, dst, dst8);
                        src_ptr += src_stride;
                        dst += dst_stride;
                        dst8 += dst8_stride;
                    } while (--y);
                    ...
                    do {
                        jnt_x_avg_2tap_64_avx512(
                            src_ptr, coeffs_512, offset_avg_512, dst, dst8);
                        jnt_x_avg_2tap_64_avx512(src_ptr + 64,
                            coeffs_512,
                            offset_avg_512,
                            dst + 64,
                            dst8 + 64);
        ...
        if (w <= 4) {
            ...
            if (w == 32) {
                do {
                    jnt_x_no_avg_2tap_32x2_avx512(src_ptr,
                        src_stride,
                        coeffs_512,
                        offset_no_avg_512,
                        dst,
                ...
                do {
                    jnt_x_no_avg_2tap_64_avx512(
                        src_ptr, coeffs_512, offset_no_avg_512, dst);
                    src_ptr += src_stride;
                    dst += dst_stride;
                } while (--y);
            }
...
static void jnt_convolve_x_6tap_avx512(
    const uint8_t *const src, const int32_t src_stride, uint8_t *dst8,
    const int32_t dst8_stride, const int32_t w, const int32_t h,
    const InterpFilterParams *const filter_params_x, const int32_t subpel_x_q4,
    const ConvolveParams *const conv_params) {
        ...
        if (conv_params->use_jnt_comp_avg) {
            ...
            if (w <= 16) {
                ...
                if (w == 32) {
                    ...
                    do {
                        jnt_x_avg_6tap_64_avx512(src_ptr,
                            coeffs_512,
                            filt_512,
                            offset_avg_512,
                            dst,
        ...
        if (w <= 16) {
            ...
            if (w == 32) {
                ...
                do {
                    jnt_x_no_avg_6tap_64_avx512(
                        src_ptr, coeffs_512, filt_512, offset_no_avg_512, dst);
                    jnt_x_no_avg_6tap_64_avx512(src_ptr + 64,
                        coeffs_512,
                        filt_512,
                        offset_no_avg_512,
                        dst + 64);
...
static void jnt_convolve_x_8tap_avx512(
    const uint8_t *const src, const int32_t src_stride, uint8_t *dst8,
    const int32_t dst8_stride, const int32_t w, const int32_t h,
    const InterpFilterParams *const filter_params_x, const int32_t subpel_x_q4,
    const ConvolveParams *const conv_params) {
        ...
        if (conv_params->use_jnt_comp_avg) {
            ...
            if (w <= 16) {
                ...
                if (w == 32) {
                    ...
                    do {
                        jnt_x_avg_8tap_64_avx512(src_ptr,
                            coeffs_512,
                            filt_512,
                            offset_avg_512,
                            dst,
        ...
        if (w <= 16) {
            ...
            if (w == 32) {
                ...
                do {
                    jnt_x_no_avg_8tap_64_avx512(
                        src_ptr, coeffs_512, filt_512, offset_no_avg_512, dst);
                    jnt_x_no_avg_8tap_64_avx512(src_ptr + 64,
                        coeffs_512,
                        filt_512,
                        offset_no_avg_512,
                        dst + 64);
...
void eb_av1_jnt_convolve_x_avx512(
    const uint8_t *src, int32_t src_stride, uint8_t *dst8, int32_t dst8_stride,
    int32_t w, int32_t h, InterpFilterParams *filter_params_x,
    InterpFilterParams *filter_params_y, const int32_t subpel_x_q4,
    const int32_t subpel_y_q4, ConvolveParams *conv_params) {
